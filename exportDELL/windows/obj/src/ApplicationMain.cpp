...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Anga Dash Reborn",d1,df,b5,0b),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("STFGames",7c,29,45,4f));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Anga Dash Reborn",d1,df,b5,0b));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Anga Dash Reborn",d1,df,b5,0b));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.stfgames.angadashreborn",5a,c1,13,f7));
HXLINE(  43)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("2.2.1",b9,ea,96,e8));
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Anga Dash Reborn",d1,df,b5,0b))
...
HXLINE(  69)		attributes->__SetField(HX_("context",ef,95,77,19), ::Dynamic(::hx::Anon_obj::Create(8)
            			...
            			->setFixed(3,HX_("background",ee,93,1d,26),2652415)
