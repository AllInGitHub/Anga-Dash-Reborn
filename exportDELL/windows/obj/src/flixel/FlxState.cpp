...
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_95_create,"flixel.FlxState","create",0x1148b519,"flixel.FlxState.create","flixel/FlxState.hx",95,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_108_draw,"flixel.FlxState","draw",0x1022c8e1,"flixel.FlxState.draw","flixel/FlxState.hx",108,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_117_openSubState,"flixel.FlxState","openSubState",0x3d5ea838,"flixel.FlxState.openSubState","flixel/FlxState.hx",117,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_127_closeSubState,"flixel.FlxState","closeSubState",0x519577cc,"flixel.FlxState.closeSubState","flixel/FlxState.hx",127,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_134_resetSubState,"flixel.FlxState","resetSubState",0x772d18e3,"flixel.FlxState.resetSubState","flixel/FlxState.hx",134,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_172_destroy,"flixel.FlxState","destroy",0x2171383d,"flixel.FlxState.destroy","flixel/FlxState.hx",172,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_193_switchTo,"flixel.FlxState","switchTo",0x5e95c7ec,"flixel.FlxState.switchTo","flixel/FlxState.hx",193,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_207_startOutro,"flixel.FlxState","startOutro",0x6cd6bca6,"flixel.FlxState.startOutro","flixel/FlxState.hx",207,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_214_onFocusLost,"flixel.FlxState","onFocusLost",0x8c2b4d80,"flixel.FlxState.onFocusLost","flixel/FlxState.hx",214,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_220_onFocus,"flixel.FlxState","onFocus",0x97b2097c,"flixel.FlxState.onFocus","flixel/FlxState.hx",220,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_228_onResize,"flixel.FlxState","onResize",0x38e71fd0,"flixel.FlxState.onResize","flixel/FlxState.hx",228,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_232_tryUpdate,"flixel.FlxState","tryUpdate",0xc75023a7,"flixel.FlxState.tryUpdate","flixel/FlxState.hx",232,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_256_get_bgColor,"flixel.FlxState","get_bgColor",0xc8234a38,"flixel.FlxState.get_bgColor","flixel/FlxState.hx",256,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_262_set_bgColor,"flixel.FlxState","set_bgColor",0xd2905144,"flixel.FlxState.set_bgColor","flixel/FlxState.hx",262,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_267_get_subStateOpened,"flixel.FlxState","get_subStateOpened",0x2fcc7460,"flixel.FlxState.get_subStateOpened","flixel/FlxState.hx",267,0xdf96844c)
HX_LOCAL_STACK_FRAME(_hx_pos_1b8de2909b3ba780_276_get_subStateClosed,"flixel.FlxState","get_subStateClosed",0x1c89bb63,"flixel.FlxState.get_subStateClosed","flixel/FlxState.hx",276,0xdf96844c)
namespace flixel{
...
void FlxState_obj::create(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_95_create)
HXLINE(  96)		if (::hx::IsNull( this->_trans )) {
HXLINE(  97)			return;
            		}
HXLINE(  99)		if (( ::Dynamic(this->_trans->__Field(HX_("type",ba,f2,08,4d),::hx::paccDynamic)).StaticCast< ::hx::EnumBase >()->_hx_getIndex() == 1)) {
HXLINE( 102)			::flixel::FlxG_obj::cameras->fade(-16777216,(( (Float)(this->_trans->__Field(HX_("duration",54,0f,8e,14),::hx::paccDynamic)) ) / ( (Float)(2) )),true,null(),null());
            		}
            	}
...
void FlxState_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_108_draw)
HXLINE( 109)		bool _hx_tmp;
HXDLIN( 109)		if (!(this->persistentDraw)) {
HXLINE( 109)			_hx_tmp = ::hx::IsNull( this->subState );
            		}
            		else {
...
HXLINE( 112)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 113)			this->subState->draw();
            		}
            	}


void FlxState_obj::openSubState( ::flixel::FlxSubState SubState){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_117_openSubState)
HXLINE( 118)		this->_requestSubStateReset = true;
HXLINE( 119)		this->_requestedSubState = SubState;
            	}
...
void FlxState_obj::closeSubState(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_127_closeSubState)
HXDLIN( 127)		this->_requestSubStateReset = true;
            	}
...
void FlxState_obj::resetSubState(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_134_resetSubState)
HXLINE( 136)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 138)			if (::hx::IsNotNull( this->subState->closeCallback )) {
HXLINE( 139)				this->subState->closeCallback();
            			}
HXLINE( 140)			if (::hx::IsNotNull( this->_subStateClosed )) {
HXLINE( 141)				this->_subStateClosed->dispatch(this->subState);
            			}
HXLINE( 143)			if (this->destroySubStates) {
HXLINE( 144)				this->subState->destroy();
            			}
            		}
HXLINE( 148)		this->subState = this->_requestedSubState;
HXLINE( 149)		this->_requestedSubState = null();
HXLINE( 151)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 154)			if (!(this->persistentUpdate)) {
HXLINE( 155)				::flixel::FlxG_obj::inputs->onStateSwitch();
            			}
HXLINE( 157)			this->subState->_parentState = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 159)			if (!(this->subState->_created)) {
HXLINE( 161)				this->subState->_created = true;
HXLINE( 162)				this->subState->create();
            			}
HXLINE( 164)			if (::hx::IsNotNull( this->subState->openCallback )) {
HXLINE( 165)				this->subState->openCallback();
            			}
HXLINE( 166)			if (::hx::IsNotNull( this->_subStateOpened )) {
HXLINE( 167)				this->_subStateOpened->dispatch(this->subState);
            			}
            		}
            	}
...
void FlxState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_172_destroy)
HXLINE( 173)		::flixel::util::FlxDestroyUtil_obj::destroy(this->_subStateOpened);
HXLINE( 174)		::flixel::util::FlxDestroyUtil_obj::destroy(this->_subStateClosed);
HXLINE( 176)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 178)			this->subState->destroy();
HXLINE( 179)			this->subState = null();
            		}
HXLINE( 181)		this->super::destroy();
            	}


bool FlxState_obj::switchTo( ::flixel::FlxState nextState){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_193_switchTo)
HXDLIN( 193)		return true;
            	}
...
void FlxState_obj::startOutro( ::Dynamic onOutroComplete){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_207_startOutro)
HXDLIN( 207)		onOutroComplete();
            	}
...
void FlxState_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_214_onFocusLost)
            	}
...
void FlxState_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_220_onFocus)
            	}
...
void FlxState_obj::onResize(int Width,int Height){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_228_onResize)
            	}
...
void FlxState_obj::tryUpdate(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_232_tryUpdate)
HXLINE( 233)		bool _hx_tmp;
HXDLIN( 233)		if (!(this->persistentUpdate)) {
HXLINE( 233)			_hx_tmp = ::hx::IsNull( this->subState );
            		}
            		else {
HXLINE( 233)			_hx_tmp = true;
            		}
HXDLIN( 233)		if (_hx_tmp) {
HXLINE( 236)			if (::flixel::FlxG_obj::keys->checkKeyArrayState(::flixel::FlxG_obj::debugger->toggleKeys,-1)) {
HXLINE( 237)				::flixel::FlxG_obj::debugger->set_visible(!(::flixel::FlxG_obj::debugger->visible));
            			}
HXLINE( 239)			this->update(elapsed);
            		}
HXLINE( 242)		if (this->_requestSubStateReset) {
HXLINE( 244)			this->_requestSubStateReset = false;
HXLINE( 245)			this->resetSubState();
            		}
HXLINE( 247)		if (::hx::IsNotNull( this->subState )) {
HXLINE( 249)			this->subState->tryUpdate(elapsed);
            		}
            	}
...
int FlxState_obj::get_bgColor(){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_256_get_bgColor)
HXDLIN( 256)		return ::flixel::FlxG_obj::cameras->get_bgColor();
            	}
...
int FlxState_obj::set_bgColor(int Value){
            	HX_STACKFRAME(&_hx_pos_1b8de2909b3ba780_262_set_bgColor)
HXDLIN( 262)		return ::flixel::FlxG_obj::cameras->set_bgColor(Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxState_obj,set_bgColor,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal1 FlxState_obj::get_subStateOpened(){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_267_get_subStateOpened)
HXLINE( 268)		if (::hx::IsNull( this->_subStateOpened )) {
HXLINE( 269)			this->_subStateOpened =  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX );
            		}
HXLINE( 271)		return this->_subStateOpened;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(FlxState_obj,get_subStateOpened,return )
 ...
 ::flixel::util::_FlxSignal::FlxSignal1 FlxState_obj::get_subStateClosed(){
            	HX_GC_STACKFRAME(&_hx_pos_1b8de2909b3ba780_276_get_subStateClosed)
HXLINE( 277)		if (::hx::IsNull( this->_subStateClosed )) {
HXLINE( 278)			this->_subStateClosed =  ::flixel::util::_FlxSignal::FlxSignal1_obj::__alloc( HX_CTX );
            		}
HXLINE( 280)		return this->_subStateClosed;
            	}
...
::hx::Val FlxState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 6:
		if (HX_FIELD_EQ(inName,"_trans") ) { _trans=inValue.Cast<  ::Dynamic >(); return inValue; }
		break;
	case 7:
...
static ::hx::StorageInfo FlxState_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::Dynamic */ ,(int)offsetof(FlxState_obj,_trans),HX_("_trans",69,df,06,12)},
	{ ::hx::fsUnknown, 0, null()}
};
