...
HX_DEFINE_STACK_FRAME(_hx_pos_060bddf2a47172f7_37_new,"flixel.addons.ui.FlxUIState","new",0xd1a4986e,"flixel.addons.ui.FlxUIState.new","flixel/addons/ui/FlxUIState.hx",37,0xa272d441)
...
void FlxUIState_obj::__construct( ::Dynamic MaxSize){
            	HX_STACKFRAME(&_hx_pos_060bddf2a47172f7_37_new)
...
HXLINE(  37)		super::__construct(MaxSize);
            	}
...
HXLINE( 127)						::String msg1 = ( (::String)(_g->value) );
HXLINE( 128)						{
HXLINE( 130)							::haxe::Log_obj::trace(msg1,::hx::SourceInfo(HX_("flixel/addons/ui/FlxUIState.hx",41,d4,72,a2),130,HX_("flixel.addons.ui.FlxUIState",7c,89,c0,87),HX_("create",fc,66,0f,7c)));
HXLINE( 131)							liveFile = null();
            						}
...
HXLINE( 156)							::String msg21 = ( (::String)(_g1->value) );
HXLINE( 158)							errorMsg = msg21;
            						}
            						else {
...
HXLINE( 166)								::String msg221 = ( (::String)(_g2->value) );
HXLINE( 168)								errorMsg = (errorMsg + (HX_(", ",74,26,00,00) + msg221));
            							}
            							else {
...
::hx::ObjectPtr< FlxUIState_obj > FlxUIState_obj::__new( ::Dynamic MaxSize) {
	::hx::ObjectPtr< FlxUIState_obj > __this = new FlxUIState_obj();
	__this->__construct(MaxSize);
	return __this;
}

::hx::ObjectPtr< FlxUIState_obj > FlxUIState_obj::__alloc(::hx::Ctx *_hx_ctx, ::Dynamic MaxSize) {
