...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Anga Dash Reborn", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Anga Dash Reborn", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "com.stfgames.angadashreborn";
		app.meta["version"] = "2.2.1";
		...
		#elseif !air
		app.window.context.attributes.background = 2652415;
