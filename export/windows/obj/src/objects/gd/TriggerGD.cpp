...
HX_LOCAL_STACK_FRAME(_hx_pos_189b3d0c25b49ba1_122_trigger,"objects.gd.TriggerGD","trigger",0x3ed87048,"objects.gd.TriggerGD.trigger","objects/gd/TriggerGD.hx",122,0xeeadc0a0)
HX_LOCAL_STACK_FRAME(_hx_pos_189b3d0c25b49ba1_147_update,"objects.gd.TriggerGD","update",0x49247cf9,"objects.gd.TriggerGD.update","objects/gd/TriggerGD.hx",147,0xeeadc0a0)
HX_LOCAL_STACK_FRAME(_hx_pos_189b3d0c25b49ba1_160_draw,"objects.gd.TriggerGD","draw",0x9c0e86f4,"objects.gd.TriggerGD.draw","objects/gd/TriggerGD.hx",160,0xeeadc0a0)
...
HX_LOCAL_STACK_FRAME(_hx_pos_189b3d0c25b49ba1_69_boot,"objects.gd.TriggerGD","boot",0x9ab9df22,"objects.gd.TriggerGD.boot","objects/gd/TriggerGD.hx",69,0xeeadc0a0)
HX_LOCAL_STACK_FRAME(_hx_pos_189b3d0c25b49ba1_78_boot,"objects.gd.TriggerGD","boot",0x9ab9df22,"objects.gd.TriggerGD.boot","objects/gd/TriggerGD.hx",78,0xeeadc0a0)
...
HXLINE( 118)		this->alreadyTriggered = false;
HXLINE(  93)		this->args = ::cpp::VirtualArray_obj::__new(0);
HXLINE(  92)		this->triggerID = 1;
HXLINE( 107)		if ((Id <= 0)) {
HXLINE( 108)			HX_STACK_DO_THROW(HX_("Invalid trigger ID. The \"trigger\" will be treated as an object",bb,1a,a0,91));
            		}
HXLINE( 109)		if (::hx::IsNull( Args )) {
HXLINE( 110)			HX_STACK_DO_THROW(HX_("Why? HOW!?",a5,db,c0,c4));
            		}
HXLINE( 111)		int Args1 = Args->get_length();
HXDLIN( 111)		if ((Args1 != ( (::cpp::VirtualArray)(::objects::gd::TriggerGD_obj::mapArg->get(Id)) )->get_length())) {
HXLINE( 112)			HX_STACK_DO_THROW(HX_("This is either a fuck up on my end, the modder's end, or you edited the level file because you were bored",cd,11,c0,55));
            		}
HXLINE( 113)		super::__construct(-((this->triggerID = Id)),GridX,GridY,Angle,Scale,Groups,null(),null());
HXLINE( 114)		this->args = Args;
HXLINE( 115)		::states::PlayState_obj::level->levelTriggers->push(::hx::ObjectPtr<OBJ_>(this));
            	}
...
void TriggerGD_obj::trigger(){
            	HX_STACKFRAME(&_hx_pos_189b3d0c25b49ba1_122_trigger)
HXDLIN( 122)		if (::objects::gd::TriggerGD_obj::mapFunc->exists(::objects::gd::TriggerGD_obj::mapID->get_string(this->triggerID))) {
HXLINE( 124)			if (!(this->alreadyTriggered)) {
HXLINE( 126)				this->alreadyTriggered = true;
HXLINE( 127)				 ::Dynamic _hx_tmp = ::objects::gd::TriggerGD_obj::mapFunc->get(::objects::gd::TriggerGD_obj::mapID->get(this->triggerID));
HXDLIN( 127)				_hx_tmp(this->args);
            			}
            		}
            		else {
HXLINE( 134)			bool _hx_tmp1;
HXDLIN( 134)			if (::objects::gd::TriggerGD_obj::mapName->exists(this->triggerID)) {
HXLINE( 134)				_hx_tmp1 = ::objects::gd::TriggerGD_obj::mapID->exists(this->triggerID);
            			}
            			else {
HXLINE( 134)				_hx_tmp1 = false;
            			}
HXDLIN( 134)			if (!(_hx_tmp1)) {
HXLINE( 135)				HX_STACK_DO_THROW(((HX_("The trigger of ID ",33,a9,c3,fc) + this->triggerID) + HX_(" doesn't exist or is unfinished!",76,f5,62,32)));
            			}
HXLINE( 136)			::String data = ((HX_("The function for the ",7f,59,d5,44) + ::objects::gd::TriggerGD_obj::mapName->get(this->triggerID)) + HX_(" trigger doesn't exist!",b0,f0,ca,41));
HXLINE( 137)			::haxe::Log_obj::trace(data,::hx::SourceInfo(HX_("source/objects/gd/TriggerGD.hx",2c,10,cc,bc),137,HX_("objects.gd.TriggerGD",7e,eb,b3,f8),HX_("trigger",38,55,df,25)));
HXLINE( 140)			if (::hx::IsNotNull( ::states::PlayState_obj::debugTxt )) {
HXLINE( 141)				::states::PlayState_obj::addDebugText(data);
            			}
            		}
            	}
...
void TriggerGD_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_189b3d0c25b49ba1_147_update)
HXLINE( 148)		this->set_visible(::Std_obj::isOfType(::flixel::FlxG_obj::game->_state,::hx::ClassOf< ::editor::EditorState >()));
HXLINE( 149)		this->set_visible(::Std_obj::isOfType(::flixel::FlxG_obj::game->_state,::hx::ClassOf< ::editor::EditorState >()));
HXLINE( 150)		this->super::update(elapsed);
            	}


void TriggerGD_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_189b3d0c25b49ba1_160_draw)
HXDLIN( 160)		this->super::draw();
            	}
...
HXLINE(  55)					 ::Dynamic _hx_tmp =  ::Dynamic(::hx::Anon_obj::Create(2)
            						->setFixed(0,HX_("x",78,00,00,00),(object->x + (( (Float)(Args->__get(0)) ) * ( (Float)(60) ))))
            						->setFixed(1,HX_("y",79,00,00,00),(object->y - (( (Float)(Args->__get(1)) ) * ( (Float)(60) )))));
HXDLIN(  55)					Float _hx_tmp1 = ::Math_obj::abs(::hx::TCast< Float >::cast(Args->__get(2)));
HXDLIN(  55)					::flixel::tweens::FlxTween_obj::tween(object,_hx_tmp,_hx_tmp1, ::Dynamic(::hx::Anon_obj::Create(1)
            			...
            			void _hx_run(::cpp::VirtualArray Args){
            				HX_GC_STACKFRAME(&_hx_pos_189b3d0c25b49ba1_69_boot)
HXLINE(  69)				int _g = 0;
HXDLIN(  69)				::Array< ::Dynamic> _g1 = ::backend::StfUtils_obj::getGroup(::hx::TCast< int >::cast(Args->__get(4)));
HXDLIN(  69)				while((_g < _g1->length)){
HXLINE(  69)					 ::objects::gd::ObjectGD object = _g1->__get(_g).StaticCast<  ::objects::gd::ObjectGD >();
HXDLIN(  69)					_g = (_g + 1);
HXLINE(  71)					 ::Dynamic _hx_tmp =  ::Dynamic(::hx::Anon_obj::Create(1)
            						->setFixed(0,HX_("angle",d3,43,e2,22),((object->angle + ::hx::TCast< Float >::cast(Args->__get(0))) + (::hx::TCast< int >::cast(Args->__get(1)) * 360))));
HXDLIN(  71)					Float _hx_tmp1 = ::hx::TCast< Float >::cast(Args->__get(2));
HXDLIN(  71)					::flixel::tweens::FlxTween_obj::tween(object,_hx_tmp,_hx_tmp1, ::Dynamic(::hx::Anon_obj::Create(1)
            						->setFixed(0,HX_("ease",ee,8b,0c,43),::backend::StfUtils_obj::getEase(Args->__get(3)->__Field(HX_("name",4b,72,ff,48),::hx::paccDynamic),Args->__get(3)->__Field(HX_("type",ba,f2,08,4d),::hx::paccDynamic)))));
            				}
            			}
            			HX_END_LOCAL_FUNC1((void))
            			...
            			void _hx_run(::cpp::VirtualArray Args){
            				HX_GC_STACKFRAME(&_hx_pos_189b3d0c25b49ba1_78_boot)
HXLINE(  78)				int _g = 0;
HXDLIN(  78)				::Array< ::Dynamic> _g1 = ::backend::StfUtils_obj::getGroup(::hx::TCast< int >::cast(Args->__get(6)));
HXDLIN(  78)				while((_g < _g1->length)){
HXLINE(  78)					 ::objects::gd::ObjectGD object = _g1->__get(_g).StaticCast<  ::objects::gd::ObjectGD >();
HXDLIN(  78)					_g = (_g + 1);
HXLINE(  80)					if (::hx::TCast< bool >::cast(Args->__get(2))) {
HXLINE(  81)						Args->set(0,(( (Float)(1) ) / ( (Float)(Args->__get(0)) )));
            					}
HXLINE(  82)					if (::hx::TCast< bool >::cast(Args->__get(3))) {
HXLINE(  83)						Args->set(1,(( (Float)(1) ) / ( (Float)(Args->__get(1)) )));
            					}
HXLINE(  84)					 ::flixel::math::FlxBasePoint scaley = object->scale;
HXLINE(  85)					 ::flixel::math::FlxBasePoint object1 = object->scale;
HXDLIN(  85)					 ::Dynamic _hx_tmp =  ::Dynamic(::hx::Anon_obj::Create(2)
...
HXDLIN(  85)					Float _hx_tmp1 = ::hx::TCast< Float >::cast(Args->__get(4));
HXDLIN(  85)					::flixel::tweens::FlxTween_obj::tween(object1,_hx_tmp,_hx_tmp1, ::Dynamic(::hx::Anon_obj::Create(1)
