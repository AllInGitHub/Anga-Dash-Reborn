...
HXLINE( 806)								 ::Xml def_data = _g6->__get(_g5).StaticCast<  ::Xml >();
...
HXLINE( 826)								 ::Xml defaultNode = _g8->__get(_g7).StaticCast<  ::Xml >();
...
HXLINE( 852)					 ::Xml def_data1 = _g10->__get(_g9).StaticCast<  ::Xml >();
...
HXLINE( 882)					 ::Xml defaultNode1 = _g12->__get(_g11).StaticCast<  ::Xml >();
...
HXLINE( 898)					 ::Xml var_data = _g14->__get(_g13).StaticCast<  ::Xml >();
...
HXLINE( 915)					 ::Xml mode_data = _g16->__get(_g15).StaticCast<  ::Xml >();
...
HXLINE( 933)					 ::Xml group_data = _g18->__get(_g17).StaticCast<  ::Xml >();
